...
1. Create a tibble containing three columns.
    ...
    * logistic_x_man` made from `x` transformed with a logistic function calculated from the equation <img src="https://render.githubusercontent.com/render/math?math={cdf(x)=\frac{1}{(1%2Bexp(-x))}}">.
...
1. Create a tibble containing three columns.
    ...
    * `logit_p_man` made from `p` transformed with the equation <img src="https://render.githubusercontent.com/render/math?math={log(\frac{p}{1 - p})}">.

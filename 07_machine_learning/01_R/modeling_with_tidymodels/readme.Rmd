...
Good job! You have `r nrow(telecom_training)` rows in your training data and `r `nrow(telecom_test)` rows in your test dataset. Now you can begin the model fitting process using `telecom_training`.
